            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.updateProfile') ? 'active' : '' }}"
                       href="{{ route('admin.updateProfile') }}">Изменить профиль</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.changeProfile') ? 'active' : '' }}"
                       href="{{ route('admin.changeProfile') }}">Дать права</a>
                </li>
