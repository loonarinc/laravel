    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.addNews2') ? 'active' : '' }}"
                       href="{{ route('admin.addNews2') }}">FORM</a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.test3') ? 'active' : '' }}"
                       href="{{ route('admin.test3') }}">image</a>
                </li>
                <li class="nav-item">
