    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.addCategory') ? 'active' : '' }}" href="{{ route('admin.addCategory') }}">Добавить категорию</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('admin.editCategories') ? 'active' : '' }}" href="{{ route('admin.editCategories') }}">Категории</a>
                </li>
